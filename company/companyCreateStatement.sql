...
values(1, 'Matt', 'River', 5000, 1);
insert into employee
values(2, 'Mary', 'Smith', 7000, 2);
insert into employee
values(3, 'Vera', 'River', 5500, 1);
insert into employee
values(4, 'Amanda', 'Jones', 7000, 2);
insert into employee
values(5, 'Joe', 'Doe', 4000, 3);
insert into employee
values(6, 'Peter', 'Bond', 3000, 5);
insert into employee
values(7, 'Layla', 'Driver', 5000, 5);
